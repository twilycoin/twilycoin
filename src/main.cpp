...
uint256 hashGenesisBlock("0x2eba397c3907fdea732a71aa2d86cc99bb4d0342301381ba76e32bbead0e54ae");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2eba397c3907fdea732a71aa2d86cc99bb4d0342301381ba76e32bbead0e54ae");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "if there's anything before Fri Feb 14 00:51:35 EET 2014 then shame on you";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392331774;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 386563366;
        ...
        assert(block.hashMerkleRoot == uint256("0x1336fa4c9e210fc50611d04ab323d25f705a5fe8f28ce36509293a0d393645f4"));
